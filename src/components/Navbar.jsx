...
function Navbar({openNav, setOpenNav}) {
  ...
  return (
    <div className='relative h-[8vh] w-screen bg-white flex p-5 lg:p-3 justify-between items-center' >
        <img className='h-[45px] z-[99]' src="./images/logo.png" alt="" />
        ...
        <div className={`absolute lg:static top-0 left-0  bg-white flex flex-col lg:flex-row items-center justify-center lg:justify-end lg:pr-10 w-screen lg:w-[60%] h-screen lg:h-full gap-10 transition-transform duration-500  ${openNav?"translate-y-0":'translate-y-[-100%] lg:translate-y-0'}`} >
            ...
            <p className={`nav-element relative text-black lg:text-gray-600 transition-all lg:duration-200 lg:hover:text-black text-[20px] lg:text-[16px] font-bold  cursor-pointer duration-500 delay-100 lg:delay-0 ${openNav?'translate-x-0':'translate-x-[-200%] lg:translate-x-0'}`}>Parcourir les entreprises</p>
            <p className={`nav-element relative text-black lg:text-gray-600 transition-all lg:duration-200 lg:hover:text-black text-[20px] lg:text-[16px] font-bold  cursor-pointer duration-500 delay-200 lg:delay-0 ${openNav?'translate-x-0':'translate-x-[-200%] lg:translate-x-0'}`}>Connexion</p>
